...
class PurchaseController extends Controller
{
    ...
    {
        return view('pages.purchase.create_purchase')->with('suppliers', Supplier::get())->with('product', ProductDetail::get());
    }
    ...
    {
        $from_date = DateFormat::getFormatteddate($request['from_date']);
        $to_date = DateFormat::getFormatteddate($request['to_date']);
