...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title">{{ __("message.Product") }}</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">{{ __("message.home") }}</a></li>
                <li class="breadcrumb-item"><a href="#">{{ __("message.EditPRODUCTS") }}</a></li>
            </ol>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">{{ __("message.EditPRODUCTS") }}</h4>
                <hr>
                        ...
                        <div class="p-20">
                            <form class="form-horizontal" method="post" action="/products/update"
                               ...
                               {{-- <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">{{ __("message.ProductTitle") }}</label>
                                    <div class="col-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">{{ __("message.ProductImage") }}</label>
                                    <div class="col-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">{{ __("message.PurchasePrice") }}</label>
                                    <div class="col-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">{{ __("message.RetailPrice") }}</label>
                                    <div class="col-10">
