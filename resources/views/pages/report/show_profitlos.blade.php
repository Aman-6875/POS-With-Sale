                    ...
                    <div class="col-12">
                        <div class="p-20">
                            <form class="form-inline" method="post" action="/report/profit/show"
                               ...
                               <div class="form-group mb-0 justify-content-end row col-md-2">
                                    <div class="col-10">
                                        <a href="/daily/report/profit/loss/show" class="btn btn-success waves-effect waves-light">Daily Report</a>
                                        </button>
                                    </div>
                                </div>
                                <div class="form-group mb-0 justify-content-end row col-md-2">
                                    <div class="col-10">
                                        <a href="/current-week/report/profit/loss/show" class="btn btn-primary waves-effect waves-light">Weekly Report</a>
                                        </button>
                                    </div>
                                </div>
                                 <div class="form-group mb-0 justify-content-end row col-md-2">
                                    <div class="col-10">
                                        <a href="/current-month/report/profit/loss/show" class="btn btn-default waves-effect waves-light">Monthly Report</a>
                                        </button>
                                    </div>
                                </div>
                            </form>
