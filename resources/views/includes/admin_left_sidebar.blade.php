...
<div class="left side-menu">
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-users"></i> <span> {{ __('message.contacts') }} </span>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="ti-exchange-vertical"></i> <span> {{ __('message.expenses') }} </span>
                        <span class="menu-arrow"></span> </a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="/ingredient/purchase/create">{{ __('message.newpurchase') }}</a></li>
 ...
 --}}
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="ti-receipt"></i> <span> {{ __('message.reports') }} </span>
                        <span class="menu-arrow"></span> </a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-support"></i><span> {{ __("message.settings") }} </span>
                        <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="ti-user"></i>
                        ...
                        <span class="menu-arrow"></span> </a>
                    <ul class="list-unstyled">
                        <li><a href="/user/show">{{ __('message.user') }}</a></li>
